  ...
  persist(
    ...
    }),
    {
      ...
      migrate: (persisted: unknown) => {
        ...
        const backupScope = (state?.backupScope as Record<string, unknown> | undefined) ?? {};
        state.backupScope = {
          localStorage: backupScope.localStorage !== false,
          config: backupScope.config === true,
          authFiles: backupScope.authFiles === true,
          usage: backupScope.usage !== false,
        };
        return state;
      },
      partialize: (state) => ({
